...
const CERT_PATTERNS = {
  ...
  'HUET': [/\bHUET\b/gi],
  'FOET': [/\bFOET\b/gi],
  // MIST: exclude "MIST II/III/IV" (KBR govt contract name) to avoid false positives
  'MIST': [/\bMIST\b(?!\s+(?:I{1,3}|IV|V)\b)/g],
  'OPITO': [/\bOPITO\b/gi],
  'OPITO Banksman': [/\bOPITO[\s-]+Banksman\b/gi, /\bBanksman[^.\n]{0,40}\bOPITO\b/gi, /\bOPITO\b[^.\n]{0,40}\bBanksman\b/gi],
  ...
  'CSWIP 3.1': [/\bCSWIP[\s-]*3\.1\b/gi],
  'CSWIP 3.2': [/\bCSWIP[\s-]*3\.2(?:\.\d)?\b/gi],
  'CSWIP': [/\bCSWIP\b(?!\s*[\s-]*3\.\d)/gi],
